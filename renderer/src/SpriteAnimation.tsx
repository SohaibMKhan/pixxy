...
// IMPORTANT: frame bounds are calculated ONLY inside the selected sprite cell.
// Do not inspect neighbouring cells or add padding outside the cell. The previous
// component-merging approach could pull pixels from the next Pixxy pose into the
// current pose, which is exactly the half-character artifact we are eliminating.
...
export default function SpriteAnimation({
  ...
  useEffect(() => {
    ...
    image.onload = () => {
      ...
      // All current production sheets are evenly tiled. Use exact integer cell
      // dimensions; never guess a different grid or merge adjacent cells.
      ...
      const drawFrame = () => {
        ...
        // Hard replace the displayed canvas every frame.
        ...
        const destinationY = canvas.height - (baseline * targetScale)
